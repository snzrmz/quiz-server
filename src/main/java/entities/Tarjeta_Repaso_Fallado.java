...
public class Tarjeta_Repaso_Fallado implements Serializable {
	...
	@EmbeddedId
	private Tarjeta_Repaso_FalladoPK traID;
	@JsonbTransient
	public Tarjeta_Repaso_FalladoPK getTraID() {
		return traID;
	}
	public void setTraID(Tarjeta_Repaso_FalladoPK traID) {
		this.traID = traID;
	}
	...
	public Tarjeta_Repaso_Fallado(Tarjeta_Repaso_FalladoPK traID, Repaso repaso, Tarjeta tarjeta) {
		this.traID = traID;
		this.repaso = repaso;
